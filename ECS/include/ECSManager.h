...
namespace Lina{ namespace Manager{
    ...
    {
        public:
            void addEntity(ECS::Entity* entity) {Entities.push_back(entity); EntityIDs.push_back(entity->getID()); std::cout<<"Pushed Entities: "<<Entities.size() << '\n';}
            ...
            std::vector<ECS::Entity*> getEntities() const { std::cout<<"Return Ent: "<<Entities.size() << '\n';return Entities;}
        public:
